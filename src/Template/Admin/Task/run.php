...
<be-page-content>
    ...
    <div id="app" v-cloak>
        <div class="be-p-150 be-bc-fff">
            ...
            <el-tag class="be-mt-100"><?php echo $this->task->start_page; ?></el-tag>
            ...
            <div class="be-mt-200 be-c-999">
                ...
                <ol>
                    ...
                    <li>
                        任务（<?php echo $this->task->name; ?>）的采集脚本：
                        <el-link type="primary" href="<?php echo $this->task->start_page; ?>">安装</el-link>
                    </li>
                </ol>
            </div>

            <div class="be-mt-200">
                <a class="be-btn be-btn-main" type="primary" href="<?php echo $this->task->start_page; ?>" rel="noreferrer">
